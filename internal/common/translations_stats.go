...
func StatCardLocales(name string, apostrophe string) map[string]map[string]string {
...
func WakatimeCardLocales() map[string]map[string]string {
	return map[string]map[string]string{
...
func AvailableLocales() []string {
	...
	for locale := range StatCardLocales("name", "")["statcard.title"] {
		locales[locale] = true
	}
...
func IsLocaleAvailable(locale string) bool {
	...
	target := strings.ToLower(locale)
	for _, locale := range AvailableLocales() {
		if strings.ToLower(locale) == target {
			return true
		}
	}
	return false
